...
val getDisabled : [< `ONYX_TOGGLEBUTTON ] obj -> unit -> bool
val setDisabled : [< `ONYX_TOGGLEBUTTON ] obj -> bool -> unit
...
val getValue : [< `ONYX_TEXTAREA | `TEXTAREA | `ONYX_RICHTEXT | `RICHTEXT | `ONYX_CHECKBOX | `CHECKBOX | `INPUT ] obj -> unit -> string
val setValue : [< `ONYX_TEXTAREA | `TEXTAREA | `ONYX_RICHTEXT | `RICHTEXT | `ONYX_CHECKBOX | `CHECKBOX | `INPUT ] obj -> string -> unit
...
val getActive : [< `ONYX_RADIOGROUP | `GROUP ] obj -> unit -> any_id obj
val setActive : [< `ONYX_RADIOGROUP | `GROUP ] obj -> any_id obj -> unit
...
val getDisabled : [< `ONYX_TEXTAREA | `TEXTAREA | `ONYX_RICHTEXT | `RICHTEXT | `ONYX_CHECKBOX | `CHECKBOX | `INPUT | `ONYX_MENUITEM | `ONYX_BUTTON | `BUTTON ] obj -> unit -> bool
val setDisabled : [< `ONYX_TEXTAREA | `TEXTAREA | `ONYX_RICHTEXT | `RICHTEXT | `ONYX_CHECKBOX | `CHECKBOX | `INPUT | `ONYX_MENUITEM | `ONYX_BUTTON | `BUTTON ] obj -> bool -> unit
...
val getType : [< `ONYX_TEXTAREA | `TEXTAREA | `ONYX_RICHTEXT | `RICHTEXT | `ONYX_CHECKBOX | `CHECKBOX | `INPUT ] obj -> unit -> string
val setType : [< `ONYX_TEXTAREA | `TEXTAREA | `ONYX_RICHTEXT | `RICHTEXT | `ONYX_CHECKBOX | `CHECKBOX | `INPUT ] obj -> string -> unit
...
val getActive : [< `ONYX_ICONBUTTON | `ONYX_INPUTDECORATOR | `ONYX_MENUITEM | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM ] obj -> unit -> bool
val setActive : [< `ONYX_ICONBUTTON | `ONYX_INPUTDECORATOR | `ONYX_MENUITEM | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM ] obj -> bool -> unit
...
val getLayoutKind : [< `FITTABLEROWS | `FITTABLECOLUMNS ] obj -> unit -> string
val setLayoutKind : [< `FITTABLEROWS | `FITTABLECOLUMNS ] obj -> string -> unit
...
val getPlaceholder : [< `ONYX_TEXTAREA | `TEXTAREA | `ONYX_RICHTEXT | `RICHTEXT | `ONYX_CHECKBOX | `CHECKBOX | `INPUT ] obj -> unit -> string
val setPlaceholder : [< `ONYX_TEXTAREA | `TEXTAREA | `ONYX_RICHTEXT | `RICHTEXT | `ONYX_CHECKBOX | `CHECKBOX | `INPUT ] obj -> string -> unit
...
val getShowing : [< `SLIDEABLE | `SELECT | `SCROLLTHUMB | `TRANSLATESCROLLSTRATEGY | `TOUCHSCROLLSTRATEGY | `SCROLLSTRATEGY | `PULLDOWNLIST | `LIST | `SCROLLER | `REPEATER | `ONYX_TOOLTIP | `ONYX_FLYWEIGHTPICKER | `ONYX_PICKER | `ONYX_MENU | `ONYX_POPUP | `POPUP | `PANELS | `OWNERPROXY | `OPTION | `ONYX_PICKERDECORATOR | `ONYX_MENUDECORATOR | `ONYX_TOOLTIPDECORATOR | `ONYX_TOOLBAR | `ONYX_TOGGLEBUTTON | `ONYX_SPINNER | `ONYX_SCRIM | `ONYX_SLIDER | `ONYX_PROGRESSBUTTON | `ONYX_PROGRESSBAR | `ONYX_MORETOOLBAR | `ONYX_ITEM | `ONYX_ICONBUTTON | `ONYX_ICON | `ONYX_GROUPBOXHEADER | `ONYX_GROUPBOX | `ONYX_GRABBER | `ONYX_DRAWER | `NODE | `ONYX_TEXTAREA | `TEXTAREA | `ONYX_RICHTEXT | `RICHTEXT | `ONYX_CHECKBOX | `CHECKBOX | `INPUT | `IMAGE | `ONYX_INPUTDECORATOR | `ONYX_MENUITEM | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `ONYX_RADIOGROUP | `GROUP | `FLYWEIGHTREPEATER | `FITTABLEROWS | `FITTABLECOLUMNS | `CANVAS | `CONTROL ] obj -> unit -> bool
val setShowing : [< `SLIDEABLE | `SELECT | `SCROLLTHUMB | `TRANSLATESCROLLSTRATEGY | `TOUCHSCROLLSTRATEGY | `SCROLLSTRATEGY | `PULLDOWNLIST | `LIST | `SCROLLER | `REPEATER | `ONYX_TOOLTIP | `ONYX_FLYWEIGHTPICKER | `ONYX_PICKER | `ONYX_MENU | `ONYX_POPUP | `POPUP | `PANELS | `OWNERPROXY | `OPTION | `ONYX_PICKERDECORATOR | `ONYX_MENUDECORATOR | `ONYX_TOOLTIPDECORATOR | `ONYX_TOOLBAR | `ONYX_TOGGLEBUTTON | `ONYX_SPINNER | `ONYX_SCRIM | `ONYX_SLIDER | `ONYX_PROGRESSBUTTON | `ONYX_PROGRESSBAR | `ONYX_MORETOOLBAR | `ONYX_ITEM | `ONYX_ICONBUTTON | `ONYX_ICON | `ONYX_GROUPBOXHEADER | `ONYX_GROUPBOX | `ONYX_GRABBER | `ONYX_DRAWER | `NODE | `ONYX_TEXTAREA | `TEXTAREA | `ONYX_RICHTEXT | `RICHTEXT | `ONYX_CHECKBOX | `CHECKBOX | `INPUT | `IMAGE | `ONYX_INPUTDECORATOR | `ONYX_MENUITEM | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `ONYX_RADIOGROUP | `GROUP | `FLYWEIGHTREPEATER | `FITTABLEROWS | `FITTABLECOLUMNS | `CANVAS | `CONTROL ] obj -> bool -> unit
...
val getLayoutKind : [< `SLIDEABLE | `SELECT | `SCROLLTHUMB | `TRANSLATESCROLLSTRATEGY | `TOUCHSCROLLSTRATEGY | `SCROLLSTRATEGY | `PULLDOWNLIST | `LIST | `SCROLLER | `REPEATER | `ONYX_TOOLTIP | `ONYX_FLYWEIGHTPICKER | `ONYX_PICKER | `ONYX_MENU | `ONYX_POPUP | `POPUP | `PANELS | `OWNERPROXY | `OPTION | `ONYX_PICKERDECORATOR | `ONYX_MENUDECORATOR | `ONYX_TOOLTIPDECORATOR | `ONYX_TOOLBAR | `ONYX_TOGGLEBUTTON | `ONYX_SPINNER | `ONYX_SCRIM | `ONYX_SLIDER | `ONYX_PROGRESSBUTTON | `ONYX_PROGRESSBAR | `ONYX_MORETOOLBAR | `ONYX_ITEM | `ONYX_ICONBUTTON | `ONYX_ICON | `ONYX_GROUPBOXHEADER | `ONYX_GROUPBOX | `ONYX_GRABBER | `ONYX_DRAWER | `NODE | `ONYX_TEXTAREA | `TEXTAREA | `ONYX_RICHTEXT | `RICHTEXT | `ONYX_CHECKBOX | `CHECKBOX | `INPUT | `IMAGE | `ONYX_INPUTDECORATOR | `ONYX_MENUITEM | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `ONYX_RADIOGROUP | `GROUP | `FLYWEIGHTREPEATER | `FITTABLEROWS | `FITTABLECOLUMNS | `CANVAS | `CONTROL | `CANVAS_TEXT | `CANVAS_RECTANGLE | `CANVAS_CIRCLE | `CANVAS_SHAPE | `CANVAS_IMAGE | `CANVAS_CONTROL | `UICOMPONENT ] obj -> unit -> string
val setLayoutKind : [< `SLIDEABLE | `SELECT | `SCROLLTHUMB | `TRANSLATESCROLLSTRATEGY | `TOUCHSCROLLSTRATEGY | `SCROLLSTRATEGY | `PULLDOWNLIST | `LIST | `SCROLLER | `REPEATER | `ONYX_TOOLTIP | `ONYX_FLYWEIGHTPICKER | `ONYX_PICKER | `ONYX_MENU | `ONYX_POPUP | `POPUP | `PANELS | `OWNERPROXY | `OPTION | `ONYX_PICKERDECORATOR | `ONYX_MENUDECORATOR | `ONYX_TOOLTIPDECORATOR | `ONYX_TOOLBAR | `ONYX_TOGGLEBUTTON | `ONYX_SPINNER | `ONYX_SCRIM | `ONYX_SLIDER | `ONYX_PROGRESSBUTTON | `ONYX_PROGRESSBAR | `ONYX_MORETOOLBAR | `ONYX_ITEM | `ONYX_ICONBUTTON | `ONYX_ICON | `ONYX_GROUPBOXHEADER | `ONYX_GROUPBOX | `ONYX_GRABBER | `ONYX_DRAWER | `NODE | `ONYX_TEXTAREA | `TEXTAREA | `ONYX_RICHTEXT | `RICHTEXT | `ONYX_CHECKBOX | `CHECKBOX | `INPUT | `IMAGE | `ONYX_INPUTDECORATOR | `ONYX_MENUITEM | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `ONYX_RADIOGROUP | `GROUP | `FLYWEIGHTREPEATER | `FITTABLEROWS | `FITTABLECOLUMNS | `CANVAS | `CONTROL | `CANVAS_TEXT | `CANVAS_RECTANGLE | `CANVAS_CIRCLE | `CANVAS_SHAPE | `CANVAS_IMAGE | `CANVAS_CONTROL | `UICOMPONENT ] obj -> string -> unit
...
val getActive : [< `ONYX_TOGGLEBUTTON | `ONYX_CHECKBOX | `CHECKBOX ] obj -> unit -> bool
val setActive : [< `ONYX_TOGGLEBUTTON | `ONYX_CHECKBOX | `CHECKBOX ] obj -> bool -> unit

val getValue : [< `OPTION ] obj -> unit -> string
val setValue : [< `OPTION ] obj -> string -> unit

val getMin : [< `SLIDEABLE ] obj -> unit -> int
val setMin : [< `SLIDEABLE ] obj -> int -> unit

val getCallbackName : [< `JSONPREQUEST ] obj -> unit -> string
val setCallbackName : [< `JSONPREQUEST ] obj -> string -> unit

val getTapHighlight : [< `ONYX_ITEM ] obj -> unit -> bool
val setTapHighlight : [< `ONYX_ITEM ] obj -> bool -> unit

val getValue : [< `SLIDEABLE ] obj -> unit -> int
val setValue : [< `SLIDEABLE ] obj -> int -> unit
...
val getShowing : [< `DRAGAVATAR ] obj -> unit -> bool
val setShowing : [< `DRAGAVATAR ] obj -> bool -> unit

val getValue : [< `ONYX_TOGGLEBUTTON ] obj -> unit -> bool
val setValue : [< `ONYX_TOGGLEBUTTON ] obj -> bool -> unit

val getNoStretch : [< `FITTABLEROWS | `FITTABLECOLUMNS ] obj -> unit -> bool
val setNoStretch : [< `FITTABLEROWS | `FITTABLECOLUMNS ] obj -> bool -> unit

val getCallbackName : [< `WEBSERVICE ] obj -> unit -> string
val setCallbackName : [< `WEBSERVICE ] obj -> string -> unit
...
let getCallbackName this () =
	let value = meth_call this "getCallbackName" [||] in
		to_string value
let setCallbackName this chaine1 =
