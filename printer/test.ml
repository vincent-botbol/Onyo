...
val getValue : [< `ONYX_TEXTAREA | `TEXTAREA | `ONYX_RICHTEXT | `RICHTEXT | `ONYX_CHECKBOX | `CHECKBOX | `ONYX_INPUT | `INPUT ] obj -> unit -> string
val setValue : [< `ONYX_TEXTAREA | `TEXTAREA | `ONYX_RICHTEXT | `RICHTEXT | `ONYX_CHECKBOX | `CHECKBOX | `ONYX_INPUT | `INPUT ] obj -> string -> unit
...
val getDisabled : [< `ONYX_TEXTAREA | `TEXTAREA | `ONYX_RICHTEXT | `RICHTEXT | `ONYX_CHECKBOX | `CHECKBOX | `ONYX_INPUT | `INPUT | `ONYX_MENUITEM | `ONYX_BUTTON | `BUTTON ] obj -> unit -> bool
val setDisabled : [< `ONYX_TEXTAREA | `TEXTAREA | `ONYX_RICHTEXT | `RICHTEXT | `ONYX_CHECKBOX | `CHECKBOX | `ONYX_INPUT | `INPUT | `ONYX_MENUITEM | `ONYX_BUTTON | `BUTTON ] obj -> bool -> unit
