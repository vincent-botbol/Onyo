module Enyo : sig
type any_id = [`ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL | `UICOMPONENT | `COMPONENT | `OBJECT]
...
val hide : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL ] obj -> unit -> unit

val stylesToNode : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL ] obj -> unit -> unit

val show : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL ] obj -> bool -> unit

val destroy : [< `ONYX_TOOLBAR | `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICONBUTTON | `ONYX_ICON | `ONYX_ICON | `IMAGE | `IMAGE | `ONYX_BUTTON | `ONYX_BUTTON | `BUTTON | `BUTTON | `TOOLDECORATOR | `TOOLDECORATOR | `GROUPITEM | `GROUPITEM | `INPUT | `INPUT | `CANVAS | `CANVAS | `CONTROL | `CONTROL | `UICOMPONENT | `UICOMPONENT | `COMPONENT ] obj -> unit -> unit

val warn : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL | `UICOMPONENT | `COMPONENT | `OBJECT ] obj -> string -> unit

val destroyComponents : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL | `UICOMPONENT | `COMPONENT ] obj -> unit -> unit

val addRemoveClass : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL ] obj -> string -> bool -> unit

val addClass : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL ] obj -> string -> unit

val makeId : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL | `UICOMPONENT | `COMPONENT ] obj -> unit -> unit

val hasClass : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL ] obj -> string -> bool

val destroyObject : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL | `UICOMPONENT | `COMPONENT | `OBJECT ] obj -> string -> unit

val addStyles : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL ] obj -> string -> unit

val setBounds : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL ] obj -> int -> int -> int -> int -> unit

val getComponents : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL | `UICOMPONENT | `COMPONENT ] obj -> unit -> any_id obj list

val getClassAttribute : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL ] obj -> unit -> string

val log : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL | `UICOMPONENT | `COMPONENT | `OBJECT ] obj -> string -> unit

val update : [< `CANVAS ] obj -> unit -> unit

val removeClass : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL ] obj -> string -> unit

val rendered : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL ] obj -> unit -> unit

val addComponent : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL | `UICOMPONENT | `COMPONENT ] obj -> any_id obj -> unit

val getControls : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL | `UICOMPONENT ] obj -> unit -> any_id obj list

val renderInto : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL ] obj -> dom_node -> unit

val write : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL ] obj -> unit -> unit

val error : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL | `UICOMPONENT | `COMPONENT | `OBJECT ] obj -> string -> unit

val addContent : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL ] obj -> string -> unit

val render : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL ] obj -> unit -> unit

val getId : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL | `UICOMPONENT | `COMPONENT ] obj -> unit -> string
val setId : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL | `UICOMPONENT | `COMPONENT ] obj -> string -> unit

val getValue : [< `INPUT ] obj -> unit -> string
val setValue : [< `INPUT ] obj -> string -> unit

val getName : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL | `UICOMPONENT | `COMPONENT ] obj -> unit -> string
val setName : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL | `UICOMPONENT | `COMPONENT ] obj -> string -> unit

val getControlParentName : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL | `UICOMPONENT ] obj -> unit -> string
val setControlParentName : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL | `UICOMPONENT ] obj -> string -> unit

val getDisabled : [< `ONYX_BUTTON | `BUTTON | `INPUT ] obj -> unit -> bool
val setDisabled : [< `ONYX_BUTTON | `BUTTON | `INPUT ] obj -> bool -> unit

val getStyle : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL ] obj -> unit -> string
val setStyle : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL ] obj -> string -> unit

val getOwner : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL | `UICOMPONENT | `COMPONENT ] obj -> unit -> any_id obj
val setOwner : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL | `UICOMPONENT | `COMPONENT ] obj -> any_id obj -> unit

val getParent : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL | `UICOMPONENT ] obj -> unit -> any_id obj
val setParent : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL | `UICOMPONENT ] obj -> any_id obj -> unit
...
val getContent : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL ] obj -> unit -> string
val setContent : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL ] obj -> string -> unit

val getFit : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL ] obj -> unit -> bool
val setFit : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL ] obj -> bool -> unit

val getPlaceholder : [< `INPUT ] obj -> unit -> string
val setPlaceholder : [< `INPUT ] obj -> string -> unit

val getAllowHtml : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL ] obj -> unit -> bool
val setAllowHtml : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL ] obj -> bool -> unit

val getNoEvents : [< `IMAGE ] obj -> unit -> bool
val setNoEvents : [< `IMAGE ] obj -> bool -> unit

val getContainer : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL | `UICOMPONENT ] obj -> unit -> any_id obj
val setContainer : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL | `UICOMPONENT ] obj -> any_id obj -> unit

val getShowing : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL ] obj -> unit -> bool
val setShowing : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL ] obj -> bool -> unit

val getTag : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL ] obj -> unit -> string
val setTag : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL ] obj -> string -> unit

val getLayoutKind : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL | `UICOMPONENT ] obj -> unit -> string
val setLayoutKind : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL | `UICOMPONENT ] obj -> string -> unit

val getSrc : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL ] obj -> unit -> string
val setSrc : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL ] obj -> string -> unit

val getClasses : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL ] obj -> unit -> string
val setClasses : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL ] obj -> string -> unit

val getIsContainer : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL ] obj -> unit -> bool
val setIsContainer : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL ] obj -> bool -> unit

val getCanGenerate : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL ] obj -> unit -> bool
val setCanGenerate : [< `ONYX_TOOLBAR | `ONYX_GRABBER | `ONYX_ICONBUTTON | `ONYX_ICON | `IMAGE | `ONYX_BUTTON | `BUTTON | `TOOLDECORATOR | `GROUPITEM | `INPUT | `CANVAS | `CONTROL ] obj -> bool -> unit
